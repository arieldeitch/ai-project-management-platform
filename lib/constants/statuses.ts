...
> = {
  idea:      { label: 'רעיון',    color: 'bg-zinc-100 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-400',              dot: 'bg-zinc-400' },
  scoped:    { label: 'באפיון',   color: 'bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-400',               dot: 'bg-sky-500' },
